...
export default function SignUp(props) {
  ...
  const  responseInfo= useGetsinglecustomerQuery(id);
  ...
  const [editSingleclient] =   useEditSingleclientMutation()
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      ...
      const res = await editSingleclient({actual_data , id});
      console.log(res, "res");
